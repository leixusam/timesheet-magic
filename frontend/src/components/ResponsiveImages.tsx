...
// Generated on 2025-05-30T23:55:44.458Z
...
export const cafeResponsiveImage: React.FC<ResponsiveImageProps> = ({ 
  ...
  return (
    <picture>
      <source srcSet="/optimized/cafe-mobile.avif 480w, /optimized/cafe-mobile-md.avif 768w, /optimized/cafe-mobile@2x.avif 960w, /optimized/cafe-tablet.avif 1024w" type="image/avif" sizes={sizes} />
      <source srcSet="/optimized/cafe-mobile.webp 480w, /optimized/cafe-mobile-md.webp 768w, /optimized/cafe-mobile@2x.webp 960w, /optimized/cafe-tablet.webp 1024w" type="image/webp" sizes={sizes} />
      <img
...
export const nwLx1Cp6tWit8e855xsUwKCQDcResponsiveImage: React.FC<ResponsiveImageProps> = ({ 
  ...
  return (
    <picture>
      <source srcSet="/optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile.avif 480w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile-md.avif 768w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile@2x.avif 960w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-tablet.avif 1024w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-desktop.avif 1920w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-tablet@2x.avif 2048w" type="image/avif" sizes={sizes} />
      <source srcSet="/optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile.webp 480w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile-md.webp 768w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-mobile@2x.webp 960w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-tablet.webp 1024w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-desktop.webp 1920w, /optimized/nwLx1Cp6tWit8e855xsUwKCQDc-tablet@2x.webp 2048w" type="image/webp" sizes={sizes} />
      <img
...
export const lU9jqP5P9GHVLS9zK5S3sXL7YResponsiveImage: React.FC<ResponsiveImageProps> = ({ 
  ...
  return (
    <picture>
      <source srcSet="/optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile.avif 480w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile-md.avif 768w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile@2x.avif 960w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-tablet.avif 1024w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-desktop.avif 1920w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-tablet@2x.avif 2048w" type="image/avif" sizes={sizes} />
      <source srcSet="/optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile.webp 480w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile-md.webp 768w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-mobile@2x.webp 960w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-tablet.webp 1024w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-desktop.webp 1920w, /optimized/lU9jqP5P9GHVLS9zK5S3sXL7Y-tablet@2x.webp 2048w" type="image/webp" sizes={sizes} />
      <img
