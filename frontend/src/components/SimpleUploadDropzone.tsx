  ...
  return (
    <div className={`${className}`}>
      ...
      <div className="mt-4 text-center">
        <p className="text-xs text-gray-400 mb-2">Don't have a timesheet handy?</p>
        <a
          href="/sample time sheet.csv"
          download="sample-timesheet.csv"
          ...
          onClick={() => {
            ...
            analytics.track('sample_download', {
              source: 'upload_dropzone',
              filename: 'sample-timesheet.csv'
            });
          }}
        >
